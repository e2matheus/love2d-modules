--[[
    ...
    drawn inside a grid. The game takes input from the user and increases
    the size of the chain by 1. It also gets input from the user to move
    the chain's head in one of four directions to adjacent grid cells,
    depending on the pressed key, and the rest of the squares follow the
    head's trajectory.
]]
...
function love.load()
    ...
    -- Update the square chain's position every second
...
--[[
    ...
    will set the chain's growth flag to true.
]]
