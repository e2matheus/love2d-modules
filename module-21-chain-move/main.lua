--[[
    ...
    drawn inside a grid. The game takes input from the user and moves
    the chain's head in one of four directions to adjacent grid cells,
    depending on the pressed key, and the rest of the squares follow
    its trajectory.
]]
...
--[[
    ...
    Arrow keys will determine the chain's head direction.
]]
